...
// let Check = document.getElementsByClassName("numberCheck").value;
...
//     count++;
//     if (Check > random) {
//         alertMessage.innerHTML = "Số bạn đoán hơi lớn"
//     } else if (Check < random) {
//         alertMessage.innerHTML = "Số bạn đoán quá nhỏ"
//     } else {
//         alertMessage.innerHTML = "Đúng rồi";
//     }
//     resultMessage.innerHTML += `lan doan thu ${count}`
// }
// location.reload();// tải lại trnag
